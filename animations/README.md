...
<div class="container-row">
    ...
    <div class="pen-container">
        <h3>Animated SVG</h3>
        <p class="codepen" data-height="480" data-default-tab="css,result" data-slug-hash="dyBNNLd" data-pen-title="CSS Animation - Celebrate" data-user="Josh-Harrison" style="height: 420px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;">
